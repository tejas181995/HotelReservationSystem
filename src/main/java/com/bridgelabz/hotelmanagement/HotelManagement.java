...
public class HotelManagement {
    ...
    public static TreeMap<Long, ArrayList<Hotel>> weekEndWeekDaysRates(){
        TreeMap<Long, ArrayList<Hotel>> hotelRates = new TreeMap<>();
        for (Hotel hotel: hotels){
            long rate = getTotalRates(hotel);
    ...
    public static void showCheapHotel(){
        ...
        TreeMap<Long, ArrayList<Hotel>> hotelRates = weekEndWeekDaysRates();
        System.out.print("\ncheapest hotels are " );
    ...
    public static Hotel getCheapestHotelByRating(){
